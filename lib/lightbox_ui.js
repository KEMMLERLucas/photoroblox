...
function display_lightbox(data) {
    ...
    console.log(data);
    console.log("Prochain élément : " + container.parentNode.nextSibling);
    ...
    console.log(lightbox.prevSibling.getAttribute('data-uri'));
    container.querySelector("#prevImgButton").addEventListener('click', (e)=> {
        console.log(lightbox.prevSibling.getAttribute('data-uri'));
        lightbox.load(lightbox.prevSibling);
    });

    container.querySelector("#nextImgButton").addEventListener('click', (e)=> {
        console.log("HEUSS suivant");
        lightbox.load(lightbox.nextSibling);
    });
